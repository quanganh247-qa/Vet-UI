  ...
  return (
    <div className="grid grid-cols-4 gap-4 p-4">
      <div className="bg-white rounded-lg shadow-sm p-4">
        <h3 className="text-gray-600 text-sm font-medium">Đã lên lịch</h3>
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <h3 className="text-gray-600 text-sm font-medium">Đang chờ</h3>
        <div className="mt-2 flex items-center">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <h3 className="text-gray-600 text-sm font-medium">Đang khám</h3>
        <div className="mt-2 flex items-center">
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
        <h3 className="text-gray-600 text-sm font-medium">Hoàn thành</h3>
        <div className="mt-2 flex items-center">
