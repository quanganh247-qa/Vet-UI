...
const DailyCheckinsChart = ({ data }: { data: { current: number[], previous: number[] } }) => {
  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      ...
      >
        ...
        />
        <Tooltip 
          formatter={(value, name) => [value, name === 'current' ? 'This Week' : 'Last Week']}
          contentStyle={{ 
            backgroundColor: '#fff',
            border: '1px solid #f0f0f0',
            borderRadius: '4px',
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm">
      <div className="flex justify-between items-center p-4 border-b border-gray-100">
        <h2 className="text-lg font-display font-semibold text-[#12263F]">Analytics</h2>
        <div>
        ...
        <div className="flex flex-wrap -mx-2">
          <div className="w-full md:w-1/2 px-2 mb-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="text-sm font-medium text-gray-500 mb-2">Appointments by Type</h3>
          ...
          <div className="w-full md:w-1/2 px-2 mb-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <h3 className="text-sm font-medium text-gray-500 mb-2">Daily Check-ins</h3>
