...
const invoiceData = [
  {
    ...
    dueDate: "2023-11-30",
    status: "unpaid",
    description: "Veterinary services for poodle - Bella",
    items: [
      { name: "General checkup", price: 250000 },
      { name: "Vaccination", price: 350000 },
      { name: "Grooming services", price: 150000 },
    ]
  },
  {
    id: "INV-0011",
    ...
    dueDate: "2023-11-15",
    status: "paid",
    description: "Emergency treatment - Golden Retriever - Max",
    items: [
      { name: "Emergency consultation", price: 300000 },
      { name: "X-Ray", price: 280000 },
    ]
  },
  {
    id: "INV-0010",
    ...
    dueDate: "2023-11-05",
    status: "paid",
    description: "Regular checkup and medication for cat - Luna",
    items: [
      { name: "Regular checkup", price: 200000 },
      { name: "Medication", price: 150000 },
      { name: "Blood test", price: 80000 },
    ]
  },
]
...
const BillingPage = () => {
  const [activeInvoice, setActiveInvoice] = useState(invoiceData[0]);
  const [paymentMethod, setPaymentMethod] = useState<"vietqr" | "paypal">("vietqr");
  const [paymentStatus, setPaymentStatus] = useState<"idle" | "processing" | "success" | "failed">("idle");
  const [filterStatus, setFilterStatus] = useState("all");
  const [searchQuery, setSearchQuery] = useState("");
  
  // Mock QR code URL - in a real implementation, this would be generated from the backend
  const qrImageUrl = "https://api.vietqr.io/image/970422-220220222419-E4jYBZ1.jpg?amount=750000&addInfo=Payment%20for%20INV-0012&accountName=DINH%20HUU%20QUANG%20ANH";
  ...
  const handlePayNow = () => {
    ...
    setTimeout(() => {
      ...
      // Would update state here in a real implementation
    }, 2000);
  };
                ...
                {filteredInvoices.map((invoice) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <h3 className="font-medium text-gray-900 dark:text-gray-100">{invoice.id}</h3>
            ...
            <CardHeader className="pb-3">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription>Invoice {activeInvoice.id}</CardDescription>
                </div>
                <Badge
            ...
            <CardContent className="py-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-gray-100">{format(new Date(activeInvoice.dueDate), "MMM dd, yyyy")}</p>
                </div>
                      ...
                      {paymentMethod === "vietqr" ? (
                        <div className="flex flex-col items-center">
                          <div className="p-4 bg-white border border-gray-200 dark:border-gray-700 rounded-lg mb-4">
                            <img src={qrImageUrl} alt="VietQR Code" className="w-64 h-64 mx-auto" />
                          </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      <div className="flex items-center gap-1">
                        ...
                        <span>Due: {format(new Date(activeInvoice.dueDate), "MMM dd, yyyy")}</span>
                      </div>
                    </div>
                    <Button 
