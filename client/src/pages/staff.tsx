...
const renderStaffView = (filteredStaff: Staff[] | undefined, viewMode: 'list' | 'grid', handleStaffClick: (id: number) => void) => {
          ...
          >
            ...
            <CardHeader className="pb-2">
              ...
              <CardDescription className="flex items-center gap-1">
                ...
                {staff.specialty && <span className="text-gray-400 dark:text-gray-500"> • {staff.specialty}</span>}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 gap-y-2 text-sm">
                ...
                {staff.certifications && staff.certifications.length > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600 dark:text-gray-300">{staff.certifications[0]}</span>
                  </div>
                )}
              </div>
            ...
            {filteredStaff.map((staff) => (
              ...
              >
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      {staff.specialty && (
                        <div className="text-sm text-gray-500 dark:text-gray-400">{staff.specialty}</div>
                      )}
                    </div>
                  </div>
                </td>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  {staff.certifications && staff.certifications.length > 1 && (
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      +{staff.certifications.length - 1} more
                    </div>
                  )}
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
