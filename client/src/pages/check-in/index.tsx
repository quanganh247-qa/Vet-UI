...
const CheckIn = () => {
  ...
  // Function to ensure base64 URL is properly formatted
  ...
  console.log("qrCode data:", qrMutation.data);
  ...
  const handleCompleteCheckIn = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Patient has been checked in and SOAP notes have been saved.",
      ...
      toast({
        ...
        description:
          "There was a problem completing the check-in process. Please try again.",
        variant: "destructive",
      });
    }
  };
                    ...
                    <div id="qrCode" className="space-y-3">
                      <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100 mb-4">
                        ...
                        <div className="flex items-center justify-center">
                          <div className="bg-white p-2 rounded-lg shadow-sm">
                            <img
                              // src={formatBase64Image(qrMutation.data.QRDataURL)}
                              src={qrMutation.data.QRDataURL}
                              alt="QR Code"
                              className="w-32 h-32"
                            />
                          </div>
